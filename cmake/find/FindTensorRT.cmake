...
if(TensorRT_INCLUDE_DIR AND EXISTS "${TensorRT_INCLUDE_DIR}/NvInfer.h")
    ...
    file(STRINGS "${_VersionSearchFile}" TensorRT_MAJOR REGEX "^#define TRT_MAJOR_ENTERPRISE [0-9]+.*$")
    file(STRINGS "${_VersionSearchFile}" TensorRT_MINOR REGEX "^#define TRT_MINOR_ENTERPRISE [0-9]+.*$")
    file(STRINGS "${_VersionSearchFile}" TensorRT_PATCH REGEX "^#define TRT_PATCH_ENTERPRISE [0-9]+.*$")
